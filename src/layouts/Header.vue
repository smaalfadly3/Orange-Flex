    ...
    <div class="flex lg:flex-1">
      <a href="#" class="-m-1.5 p-1.5">
        <span class="sr-only">Your Company</span>
          <img class="h-8 w-auto" src="../components/icons/orange-flex.png" alt="" />
      </a>
    </div>
...
<!--          
            ...
            <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Flex 🧡 klimat</a>
            <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Blog</a>
            <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Pomoc</a>
    </div>
